            ...
            <div className={cx('container')}>
                ...
                {step === 1 && (
                    <div className={cx('container__review')}>
                        <div className={cx('review__value')}>
                            <h1 className={cx('title')}>Bạn cảm thấy nơi ở của Edgar như thế nào</h1>
                ...
                {step === 3 && (
                    <div className={cx('container__description')}>
                        ...
                        <h3 className={cx('title')}>Nhà của Edgar so với mong đợi của bạn như thế nào</h3>
                ...
                {step === 4 && (
                    <div className={cx('container__rate')}>
                        <h1 className={cx('title')}>Hãy cho Edgar biết về trải nghiệm của bạn tại nơi ở này</h1>
                        ...
                        <div className={cx('rate')}>
                            ...
                            {Array.from({ length: 5 }, (e, i) => {
                                return (
                                    <i
                                        className={cx('fa-star', i <= rateCommunication ? 'fa-solid' : 'fa-regular')}
                ...
                {step === 5 && (
                    <div className={cx('container__note')}>
                        ...
                        <h2 className={cx('title')}>
                            Nói với những du khách tương lai về những gì họ có thể mong đợi ở ngôi nhà của Edgar
                        </h2>
                        <textarea
                            rows="5"
                            cols="70"
                ...
                {step === 9 && (
                    <div className={cx('container__note')}>
                        <h1 className={cx('title')}>Thêm ghi chú riêng cho Edgar</h1>
                        <h2 className={cx('title')}>Đưa ra đề xuất hoặc nói lời cảm ơn với chủ nhà</h2>
                        <textarea rows="5" cols="70" onChange={(e) => setPrivateNote(e.currentTarget.value)}></textarea>
                    </div>
                )}
