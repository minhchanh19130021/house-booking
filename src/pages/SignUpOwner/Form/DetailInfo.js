        ...
        <div className={cx('basic')}>
            <div className={cx('row')}>
                ...
                <div className={cx('form-group', 'col', 'l-4', 'm-4', 'c-12')}>
                    <label htmlFor="width-house">Chiều dài (mét)</label>
                    <input name="width-house" id="width-house" type="text" />
                    <span className={cx('alert-message')}></span>
                </div>
                <div className={cx('form-group', 'col', 'l-4', 'm-4', 'c-12')}>
                    <label htmlFor="height-house">Chiều rộng (mét)</label>
                    <input name="height-house" id="height-house" type="text" />
                    <span className={cx('alert-message')}></span>
                </div>
                <div className={cx('form-group', 'col', 'l-4', 'm-4', 'c-12')}>
                ...
                <div className={cx('form-group', 'col', 'l-4', 'm-4', 'c-12')}>
                    ...
                    <select>
                        <option value="1 thú cưng">Không cho phép</option>
                        <option value="1 thú cưng">1 thú cưng</option>
                        <option value="2 thú cưng">2 thú cưng</option>
                    </select>
                </div>
                <div className={cx('form-group', 'col', 'l-12', 'm-12', 'c-6')}>
